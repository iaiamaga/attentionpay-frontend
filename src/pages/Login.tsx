          ...
          <div className="glass-panel rounded-xl p-6 shadow-2xl relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-2 gap-2">
                <button className="flex items-center justify-center gap-2 py-2 px-4 glass-panel rounded-lg hover:bg-white/10 transition-colors group">
                  <img 
                    alt="Google" 
                ...
                <button className="flex items-center justify-center gap-2 py-2 px-4 glass-panel rounded-lg hover:bg-white/10 transition-colors group border border-secondary-container/50">
                  <span className="material-symbols-outlined text-secondary-container">account_balance_wallet</span>
                  <span className="text-[12px] font-bold tracking-wider text-secondary-container">Wallet</span>
                </button>
              </div>
